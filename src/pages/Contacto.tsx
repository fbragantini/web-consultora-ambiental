    ...
    <>
      ...
      <section className="bg-gradient-hero text-primary-foreground">
        <div className="container-page grid items-center gap-12 py-20 md:grid-cols-2 md:py-24">
          ...
          <ImageSlot label="Imagen de contacto" aspect="video" className="border-white/15 shadow-soft" />
        </div>
      </section>
      ...
      <section className="container-page grid gap-12 py-20 md:grid-cols-2">
          ...
          <dl className="mt-8 space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <dd className="text-sm text-muted-foreground">contacto@consultorabragantini.com</dd>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <span className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-secondary text-accent">
              ...
              <div>
                <dt className="text-sm font-semibold">Teléfono</dt>
                <dd className="text-sm text-muted-foreground">A definir</dd>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <span className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-secondary text-accent">
        ...
        <form className="rounded-2xl border border-border bg-card p-6 shadow-card md:p-8" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="mt-6 grid gap-4">
            <div className="grid gap-1.5">
              ...
              <input id="nombre" className="rounded-md border border-input bg-background px-3 py-2 text-sm outline-none ring-ring focus:ring-2" placeholder="Tu nombre" />
            </div>
            <div className="grid gap-1.5">
              <label htmlFor="email" className="text-sm font-medium">Email</label>
              <input id="email" type="email" className="rounded-md border border-input bg-background px-3 py-2 text-sm outline-none ring-ring focus:ring-2" placeholder="tu@email.com" />
            </div>
            <div className="grid gap-1.5">
              <label htmlFor="mensaje" className="text-sm font-medium">Mensaje</label>
              <textarea id="mensaje" rows={5} className="resize-none rounded-md border border-input bg-background px-3 py-2 text-sm outline-none ring-ring focus:ring-2" placeholder="Contanos sobre tu proyecto" />
            </div>
            <button type="submit" className="mt-2 inline-flex items-center justify-center rounded-md bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground transition hover:opacity-90">
              Enviar mensaje
            </button>
            <p className="text-xs text-muted-foreground">
              * Formulario informativo. Podemos conectarlo a tu email cuando quieras.
            </p>
          </div>
        </form>
      </section>
      ...
      <section className="container-page pb-24">
        <div className="rounded-3xl border border-border bg-secondary/50 p-10 md:p-14">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            <ImageSlot label="Equipo trabajando" aspect="video" />
          </div>
